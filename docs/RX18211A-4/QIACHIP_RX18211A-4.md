...
# QIACHIP RX18211A-4 Instruction Manual DC 2V-5V 433MHz RF Superheterodyne Wireless Receiver Module

![QIACHIP RX18211A-4 Product Diagram.webp](QIACHIP_RX18211A-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP RX18211A-4 Size Figure.webp](QIACHIP_RX18211A-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 31.5mm x 11.5mm x 1mm
- Receiver Pin header pitch: 2.5 mm

## Component Description

![QIACHIP RX18211A-4 Component Description Figure.webp](QIACHIP_RX18211A-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }

<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
  <ul style="flex: 1 1 45%; margin-right: 1%;">
    <li>1: +5V (Power Input Pin)</li>
    <li>2: DAT (Signal output pin)</li>
    <li>3: GND (Power Ground Pin)</li>
  </ul>
  <ul style="flex: 1 1 45%; margin-left: 1%;">
    <li>4: GND (Power Ground Pin)</li>
    <li>5: ANT (Antenna Pin)</li>
  </ul>
</div>
...
![QIACHIP RX18211A-4 Antenna Size Figure 1.webp](QIACHIP_RX18211A-4_Antenna_Size_Figure_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP RX18211A-4 Antenna Size Figure 2.webp](QIACHIP_RX18211A-4_Antenna_Size_Figure_2.webp){ width="68%" .center loading="lazy" }
