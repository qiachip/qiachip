...
# QIACHIP KR2301 ( KR2301 Series ) Instruction Manual AC 110V 220V WIFI Ewelink Smart Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2301 Product Diagram.webp](QIACHIP_KR2301_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0
> 
> Last Updated: 2026-5-8
> 
> Model: KR2301 ( KR2301 Series )

## Product Size

![QIACHIP KR2301 Size Figure.webp](QIACHIP_KR2301_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 42mm x 42mm x 20mm

## Component Description

![QIACHIP KR2301 Component Description Figure.webp](QIACHIP_KR2301_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2301 Wiring Diagram 1.webp](QIACHIP_KR2301_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2301 Wiring Diagram 2.webp](QIACHIP_KR2301_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2301 Wiring Diagram 3.webp](QIACHIP_KR2301_Wiring_Diagram_3.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2301 Pairing with Ewelink APP Figure1.webp](QIACHIP_KR2301_Pairing_with_Ewelink_APP_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 4**

Tap the icon of the device that appears to start the pairing process, and then wait until the pairing is completed.

![QIACHIP KR2301 Pairing with Ewelink APP Figure2.webp](QIACHIP_KR2301_Pairing_with_Ewelink_APP_Figure2.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2301 Compatible Pairing Mode Figure1.webp](QIACHIP_KR2301_Compatible_Pairing_Mode_Figure1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2301 Pairing with RM2.4G remote control Figure1.webp](QIACHIP_KR2301_Pairing_with_RM2.4G_remote_control_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 2**

Simply operate according to the prompts.

![QIACHIP KR2301 Pairing with RM2.4G remote control Figure2.webp](QIACHIP_KR2301_Pairing_with_RM2.4G_remote_control_Figure2.webp){ width="50%" .center loading="lazy" }
