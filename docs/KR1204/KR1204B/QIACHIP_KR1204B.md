...
# QIACHIP KR1204B ( KR1204 Series ) Instruction Manual DC 5V-80V 433MHz RF Remote Control Switch 4-CH Relay Receiver

![QIACHIP KR1204B Product Diagram.webp](QIACHIP_KR1204B_Product_Diagram.webp){ width="400" .center loading="lazy" }
...
> Model: KR1204B ( KR1204 Series )
> 

## Product Size

![QIACHIP KR1204B Size Figure.webp](QIACHIP_KR1204B_Size_Figure.webp){ width="400" .center loading="lazy" }

- Receiver Length (L) × Width (W) × Height (H): 68mm × 48mm × 15mm
- Housing Length (L) × Width (W) × Height (H): 75mm × 54mm × 25mm
- Receiver hole horizontal spacing: 62mm; Vertical spacing: 42mm; Hole Diameter: Ø3mm

## Component Description

![QIACHIP KR1204B Component Description Figure.webp](QIACHIP_KR1204B_Component_Description_Figure.webp){ width="400" .center loading="lazy" }
...
![QIACHIP KR1204B Wiring Diagram 1.webp](QIACHIP_KR1204B_Wiring_Diagram_1.webp){ width="400" .center loading="lazy" }

Figure 1: Wiring diagram for lamps

- Load: lamps

- Input Power: DC 5V-80V

---

### Figure 2

![QIACHIP KR1204B Wiring Diagram 2.webp](QIACHIP_KR1204B_Wiring_Diagram_2.webp){ width="400" .center loading="lazy" }

Figure 2: Wiring diagram for AC motors and Lamps

- Load: AC motors and Lamps
- Input Power: DC 5V-80V
- External power supply: AC Power

---

### Figure 3

![QIACHIP KR1204B Wiring Diagram 3.webp](QIACHIP_KR1204B_Wiring_Diagram_3.webp){ width="400" .center loading="lazy" }
...
Click the learning button on the receiver once. The indicator light on the receiver will turn on, and the receiver will enter the setting state.
...
Click the learning button on the receiver twice. The indicator light on the receiver will turn on, and the receiver will enter the setting state.
...
- Press the remote control button (such as B), and the corresponding relay B on the receiver will turn on while relay A on the receiver will turn off.
...
Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The latching mode is set successfully.

### (4) Reset function

- When the KR1204B receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
...
### How to set 2CH momentary mode + 2CH toggle mode
...
Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The 2CH momentary mode + 2CH toggle mode is set successfully.
...
Click the learning button of the receiver five times. The indicator light on the receiver will turn on, and the receiver will enter the setting state.

**Step 2**

Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The 2CH momentary mode + 2CH latching mode is set successfully.
...
Click the learning button of the receiver six times. The indicator light on the receiver will turn on, and the receiver will enter the setting state.

**Step 2**

Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The 2CH toggle mode + 2CH latching mode is set successfully.
...
Click the learning button of the receiver seven times. The indicator light on the receiver will turn on, and the receiver will enter the setting state.
