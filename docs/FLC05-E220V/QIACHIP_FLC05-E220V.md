...
# QIACHIP FLC05-E220V Instruction Manual AC 175V-265V 433MHz RF Ceiling Fan Light Remote Control Switch

![QIACHIP FLC05-220V Product Diagram.webp](QIACHIP_FLC05-220V_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP FLC05-220V Size Figure.webp](QIACHIP_FLC05-220V_Size_Figure.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP FLC05-220V Component Description Figure 1.webp](QIACHIP_FLC05-220V_Component_Description_Figure_1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP FLC05-220V Component Description Figure 2.webp](QIACHIP_FLC05-220V_Component_Description_Figure_2.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP FLC05-220V Wiring Diagram 1.webp](QIACHIP_FLC05-220V_Wiring_Diagram_1.webp){ width="50%" .center loading="lazy" }

Figure 1: Wiring diagram for AC ceiling fan light

- Load:  AC ceiling fan light
- Input Power: AC 175V-265V
...
- Capacitors for our product: T2.5+3 µF (starting 2.5 µF/running 3 µF).

If the user's existing running capacitor is also 3 µF, it is the most compatible.
...
- FLC05-E220V receiver is unpaired, all previously paired transmitters lose control of it.
