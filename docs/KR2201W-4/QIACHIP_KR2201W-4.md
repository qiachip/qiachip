...
# QIACHIP KR2201W-4 Instruction Manual AC 110V 220V RF+WIFI Tuya Smart Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201W-4 Product Diagram.webp](QIACHIP_KR2201W-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201W-4 Size Figure.webp](QIACHIP_KR2201W-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 80mm x 40mm x 25mm

## Component Description

![QIACHIP KR2201W-4 Component Description Figure.webp](QIACHIP_KR2201W-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201W-4 Wiring Diagram.webp](QIACHIP_KR2201W-4_Wiring_Diagram.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201W-4 Pairing with Tuya APP Figure1.webp](QIACHIP_KR2201W-4_Pairing_with_Tuya_APP_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 4**

Enter the password of the connected 2.4G WIFI, and then wait until the device pairing is completed.

![QIACHIP KR2201W-4 Pairing with Tuya APP Figure2.webp](QIACHIP_KR2201W-4_Pairing_with_Tuya_APP_Figure2.webp){ width="50%" .center loading="lazy" }

![QIACHIP KR2201W-4 Pairing with Tuya APP Figure3.webp](QIACHIP_KR2201W-4_Pairing_with_Tuya_APP_Figure3.webp){ width="50%" .center loading="lazy" }
