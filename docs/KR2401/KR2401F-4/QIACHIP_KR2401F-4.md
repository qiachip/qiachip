...
# QIACHIP KR2401F-4 ( KR2401 Series ) Instruction Manual DC 5V-60V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2401F-4 Product Diagram.webp](QIACHIP_KR2401F-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0

> Last Updated: 2026-01-21

> Model: KR2401F-4 ( KR2401 Series )

## Product Size

![QIACHIP KR2401F-4 Size Figure.webp](QIACHIP_KR2401F-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 38mm x 28mm x 20mm

## Component Description

![QIACHIP KR2401F-4 Component Description Figure.webp](QIACHIP_KR2401F-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2401F-4 Wiring Diagram 1.webp](QIACHIP_KR2201GS-4_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2401F-4 Wiring Diagram 2.webp](QIACHIP_KR2401F-4_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }

Figure 2: Wiring diagram for Electromagnetic Lock

- Load: Electromagnetic Lock
- Input Power for the Receiver: DC 5V-60V
- Input Power for the Access Control: DC 12V
...
- When the KR2401FB receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
