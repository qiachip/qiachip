...
comments: true
---
# QIACHIP KR2201-COM Instruction Manual AC 110V 220V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201-COM Product Diagram.webp](QIACHIP_KR2201-COM_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201-COM Size Figure.webp](QIACHIP_KR2201-COM_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 55mm x 33mm x 18mm
- Housing Length (L) x Width (W) x Height (H): 65mm x 38mm x 20mm

## Component Description

![QIACHIP KR2201-COM Component Description Figure.webp](QIACHIP_KR2201-COM_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201-COM Wiring Diagram 2.webp](QIACHIP_KR2201-COM_Wiring_Diagram_2.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201-COM Wiring Diagram 1.webp](QIACHIP_KR2201-COM_Wiring_Diagram_1.webp){ width="50%" .center loading="lazy" }

Figure 2: Wiring diagram for Lamp
...
- When the KR2201-COM receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
