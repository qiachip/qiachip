...
# QIACHIP KR2201-4 ( KR2201 Series ) Instruction Manual AC 110V 220V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201-4 Product Diagram](QIACHIP_KR2201-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
> Model: KR2201-4 ( KR2201 Series )
>

## Product Size

![QIACHIP KR2201-4 Size Figure](QIACHIP_KR2201-4_Size_Figure.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201-4 Component Description Figure](QIACHIP_KR2201-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201-4 Wiring Diagram 1](QIACHIP_KR2201-4_Wiring_Diagram_1.webp){ width="50%" .center loading="lazy" }
...
- When the KR2201-4 receiver will be reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
