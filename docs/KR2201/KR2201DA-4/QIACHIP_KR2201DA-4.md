...
# QIACHIP KR2201DA-4 ( KR2201 Series ) Instruction Manual AC 110V 220V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201DA-4 Product Diagram.webp](QIACHIP_KR2201DA-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
> Model: KR2201DA-4 ( KR2201 Series )
> 

## Product Size

![QIACHIP KR2201DA-4 Size Figure.webp](QIACHIP_KR2201DA-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 40mm x 80mm x 25mm

## Component Description

![QIACHIP KR2201DA-4 Component Description Figure.webp](QIACHIP_KR2201DA-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201DA-4 Wiring Diagram.webp](QIACHIP_KR2201DA-4_Wiring_Diagram.webp){ width="50%" .center loading="lazy" }
...
- When the KR2201DA-4 receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
