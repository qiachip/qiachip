...
# QIACHIP KR2201WB ( KR2201 Series ) Instruction Manual AC 110V 220V WIFI Tuya Smart Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201WB Product Diagram.webp](QIACHIP_KR2201WB_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0

> Last Updated: 2026-02-02

> Model: KR2201WB ( KR2201 Series )

## Product Size

![QIACHIP KR2201WB Size Figure.webp](QIACHIP_KR2201WB_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 65mm x 40mm x 23mm

## Component Description

![QIACHIP KR2201WB Component Description Figure.webp](QIACHIP_KR2201WB_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201WB Wiring Diagram.webp](QIACHIP_KR2201WB_Wiring_Diagram.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201WB Pairing with Tuya APP Figure1.webp](QIACHIP_KR2201WB_Pairing_with_Tuya_APP_Figure1.webp){ width="68%" .center loading="lazy" }

**Step 4**

Enter the password of the connected 2.4G WIFI, and then wait until the device pairing is completed.

![QIACHIP KR2201WB Pairing with Tuya APP Figure2.webp](QIACHIP_KR2201WB_Pairing_with_Tuya_APP_Figure2.webp){ width="68%" .center loading="lazy" }

![QIACHIP KR2201WB Pairing with Tuya APP Figure3.webp](QIACHIP_KR2201WB_Pairing_with_Tuya_APP_Figure3.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201WB How to connect to third-party applications such as Alexa and Google assistant Figure1.webp](QIACHIP_KR2201WB_How_to_connect_to_third-party_applications_such_as_Alexa_and_Google_assistant_Figure1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201WB How to connect to third-party applications such as Alexa and Google assistant Figure2.webp](QIACHIP_KR2201WB_How_to_connect_to_third-party_applications_such_as_Alexa_and_Google_assistant_Figure2.webp){ width="68%" .center loading="lazy" }

![QIACHIP KR2201WB How to connect to third-party applications such as Alexa and Google assistant Figure3.webp](QIACHIP_KR2201WB_How_to_connect_to_third-party_applications_such_as_Alexa_and_Google_assistant_Figure3.webp){ width="68%" .center loading="lazy" }
