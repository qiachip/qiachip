...
# QIACHIP KR2201B-4 ( KR2201 Series ) Instruction Manual AC 110V 220V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201B-4 Product Diagram.webp](QIACHIP_KR2201B-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0

> Last Updated: 2026-01-19

> Model: KR2201B-4 ( KR2201 Series )

## Product Size

![QIACHIP KR2201B-4 Size Figure.webp](QIACHIP_KR2201B-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 80mm x 42mm x 30mm

## Component Description

![QIACHIP KR2201B-4 Component Description Figure.webp](QIACHIP_KR2201B-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201B-4 Wiring Diagram 1.webp](QIACHIP_KR2201B-4_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201B-4 Wiring Diagram 2.webp](QIACHIP_KR2201B-4_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }
...
- When the KR2201B-4 receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
...
Press the receiver's learning button 6 times in quick succession until the indicator light flashes and then goes off. Power-On Auto-Engagement is now set successfully.
