...
# QIACHIP KR0548-1CH ( KR0548 Series ) Instruction Manual DC 7-48V WIFI Ewelink Smart Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR0548-1CH Product Diagram.webp](QIACHIP_KR0548-1CH_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0

> Last Updated: 2026-02-10

> Model: KR0548-1CH ( KR0548 Series )

## Product Size

![QIACHIP KR0548-1CH Size Figure.webp](QIACHIP_KR0548-1CH_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 53mm x 29mm x 17mm

## Component Description

![QIACHIP KR0548-1CH Component Description Figure.webp](QIACHIP_KR0548-1CH_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR0548-1CH Wiring Diagram 1.webp](QIACHIP_KR0548-1CH_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR0548-1CH Wiring Diagram 2.webp](QIACHIP_KR0548-1CH_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }

Figure 2: For door access switches or switches of other devices

- Input Power: DC 7-48V
...
![QIACHIP KR0548-1CH Wiring Diagram 3.webp](QIACHIP_KR0548-1CH_Wiring_Diagram_3.webp){ width="68%" .center loading="lazy" }

Figure 3: Wiring diagram for Electromagnetic Lock

- Load: Electromagnetic Lock
- Input Power for Receiver: DC 7V-48V
- Input Power for Access Control: DC 12V

---

### Figure 4

![QIACHIP KR0548-1CH Wiring Diagram 4.webp](QIACHIP_KR0548-1CH_Wiring_Diagram_4.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201BY Pairing with Ewelink APP Figure1.webp](QIACHIP_KR2201BY_Pairing_with_Ewelink_APP_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 4**

Tap the icon of the device that appears to start the pairing process, and then wait until the pairing is completed.

![QIACHIP KR2201BY Pairing with Ewelink APP Figure2.webp](QIACHIP_KR2201BY_Pairing_with_Ewelink_APP_Figure2.webp){ width="50%" .center loading="lazy" }
...
Tap "+" and select "Compatible Pairing Mode" on the APP. Select Wi-Fi SSID with ITEAD-****** and enter the password 12345678, and then go back to the eWeLink APP and tap "Next". Be patient until pairing completes.

![QIACHIP KR2201BY Compatible Pairing Mode Figure1.webp](QIACHIP_KR2201BY_Compatible_Pairing_Mode_Figure1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201BY Pairing with RM2.4G remote control Figure1.webp](QIACHIP_KR2201BY_Pairing_with_RM2.4G_remote_control_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 2**

Simply operate according to the prompts.

![QIACHIP KR2201BY Pairing with RM2.4G remote control Figure2.webp](QIACHIP_KR2201BY_Pairing_with_RM2.4G_remote_control_Figure2.webp){ width="50%" .center loading="lazy" }
