...
# QIACHIP KR0548-4CH ( KR0548 Series ) Instruction Manual DC 7-48V WIFI Ewelink Smart Remote Control Switch 4-CH Relay Receiver

![QIACHIP KR0548-4CH Product Diagram.webp](QIACHIP_KR0548-4CH_Product_Diagram.webp){ width="50%" .center loading="lazy" }

> Version: V1.0

> Last Updated: 2026-02-11

> Model: KR0548-4CH ( KR0548 Series )

## Product Size

![QIACHIP KR0548-4CH Size Figure.webp](QIACHIP_KR0548-4CH_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 63mm x 48mm x 17mm

## Component Description

![QIACHIP KR0548-4CH Component Description Figure.webp](QIACHIP_KR0548-4CH_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR0548-4CH Wiring Diagram 1.webp](QIACHIP_KR0548-4CH_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR0548-4CH Wiring Diagram 2.webp](QIACHIP_KR0548-4CH_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR0548-4CH Wiring Diagram 3.webp](QIACHIP_KR0548-4CH_Wiring_Diagram_3.webp){ width="68%" .center loading="lazy" }

Figure 3: Wiring diagram for Lamp (Type-C 5V Power Input)
...
![QIACHIP KR0548-4CH Pairing with Ewelink APP Figure1.webp](QIACHIP_KR0548-4CH_Pairing_with_Ewelink_APP_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 4**

Tap icon of device that appears to start pairing process, and then wait until pairing is completed.

![QIACHIP KR0548-4CH Pairing with Ewelink APP Figure2.webp](QIACHIP_KR0548-4CH_Pairing_with_Ewelink_APP_Figure2.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR0548-4CH Compatible Pairing Mode Figure1.webp](QIACHIP_KR0548-4CH_Compatible_Pairing_Mode_Figure1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR0548-4CH Pairing with RM2.4G remote control Figure1.webp](QIACHIP_KR0548-4CH_Pairing_with_RM2.4G_remote_control_Figure1.webp){ width="50%" .center loading="lazy" }

**Step 2**

Simply operate according to prompts.

![QIACHIP KR0548-4CH Pairing with RM2.4G remote control Figure2.webp](QIACHIP_KR0548-4CH_Pairing_with_RM2.4G_remote_control_Figure2.webp){ width="50%" .center loading="lazy" }
