...
# QIACHIP RX480E-4C ( RX480E Series ) Instruction Manual DC 3V-5V 433MHz RF Decoding Wireless Receiver Module
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
  <ul style="flex: 1 1 45%; margin-right: 1%;">
    ...
    <li>5: D3 Signal output pin corresponds to remote control button value 1 (0001)</li>
  </ul>
  <ul style="flex: 1 1 45%; margin-left: 1%;">
    <li>6: D2 Signal output pin corresponds to remote control button value 2 (0010)</li>
    <li>7: D1 Signal output pin corresponds to remote control button value 4 (0100)</li>
    <li>8: D0 Signal output pin corresponds to remote control button value 8 (1000)</li>
...
![QIACHIP RX480E-4C Wiring Diagram 1.webp](QIACHIP_RX480E-4C_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
- Press and hold the remote control button with key value 8, and the D0 pin on the receiver module will output a high-level signal "1".
- Release the remote control button with key value 8, and the output signal on D0 pin of the receiver module will change to "0".
...
- Press the remote control button with key value 8 once, and the D0 pin on the receiver module will continuously output a high-level signal "1".
- Press the remote control button with key value 8 again, and the output signal on the D0 pin of the receiver module will change to "0".
...
- Press the remote control button with key value 8, and pin D0 of the receiver module will continuously output a high-level signal "1".
- Press the remote control button with key value 4, and the output signal of pin D0 of the receiver module will change to "0", then pin D1 of the receiver module will continuously output a high-level signal "1".
