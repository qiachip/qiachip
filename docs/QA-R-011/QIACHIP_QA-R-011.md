...
# QIACHIP QA-R-011 Instruction Manual DC 3.6V-24V 433MHz RF Lighting Control Module Receiver

![QIACHIP QA-R-011 Product Diagram.webp](QIACHIP_QA-R-011_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP QA-R-011 Size Figure.webp](QIACHIP_QA-R-011_Size_Figure.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP QA-R-011 Wiring Diagram.webp](QIACHIP_QA-R-011_Wiring_Diagram.webp){ width="50%" .center loading="lazy" }
...
- When the QA-R-011 receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
