...
# QIACHIP KR2201GS-4 Instruction Manual AC 110V 220V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2201GS-4 Product Diagram.webp](QIACHIP_KR2201GS-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR2201GS-4 Size Figure.webp](QIACHIP_KR2201GS-4_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 40mm x 40mm x 20mm

## Component Description

![QIACHIP KR2201GS-4 Component Description Figure.webp](QIACHIP_KR2201GS-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
  <ul style="flex: 1 1 45%; margin-right: 1%;">
    ...
    <li>Switch: Wall switch terminal</li>
  </ul>
...
![QIACHIP KR2201GS-4 Wiring Diagram 1.webp](QIACHIP_KR2201GS-4_Wiring_Diagram_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP KR2201GS-4 Wiring Diagram 2.webp](QIACHIP_KR2201GS-4_Wiring_Diagram_2.webp){ width="68%" .center loading="lazy" }

Figure 2: Wiring diagram for Lamp (with wall switch control)

- Load: Lamp
- Input Power: AC 90V-250V
- Wall switch support: This setting allows you to continue using your existing wall switches to control the lights.
...
Click the learning button of the receiver four times. The indicator light on the receiver will flash and then turn on, and the receiver will enter the setting state.

**Step 2**

Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The momentary mode will be set successfully.
...
Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn off. The toggle mode will be set successfully.
...
Press the button on the remote control (such as A) once. The indicator light on the receiver will flash and then turn on.
...
- When the KR2201GS-4 receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.

### How to reset

Click the learning button on the receiver 8 times. The indicator light will flash and then turn off. The reset will be complete.
