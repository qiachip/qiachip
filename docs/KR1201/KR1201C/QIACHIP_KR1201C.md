...
# QIACHIP KR1201C ( KR1201 Series ) Instruction Manual DC 12V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR1201C Product Diagram.webp](QIACHIP_KR1201C_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
> Model: KR1201C ( KR1201 Series )
> 

## Product Size

![QIACHIP KR1201C Size Figure.webp](QIACHIP_KR1201C_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 35mm x 30mm x 18mm
- Housing Length (L) x Width (W) x Height (H): 40mm x 35mm x 25mm

## Component Description

![QIACHIP KR1201C Component Description Figure.webp](QIACHIP_KR1201C_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR1201C Wiring Diagram 1.webp](QIACHIP_KR1201C_Wiring_Diagram_1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR1201C Wiring Diagram 2.webp](QIACHIP_KR1201C_Wiring_Diagram_2.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP KR1201C Wiring Diagram 3.webp](QIACHIP_KR1201C_Wiring_Diagram_3.webp){ width="50%" .center loading="lazy" }
...
- When the KR1201C receiver is reset, all paired transmitters will be unpaired and will no longer be able to control the receiver.
