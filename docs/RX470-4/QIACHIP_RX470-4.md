...
# QIACHIP RX470-4 Instruction Manual DC 2V-5V 433MHz RF Superheterodyne Wireless Receiver Module

![QIACHIP RX470-4 Product Diagram.webp](QIACHIP_RX470-4_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP RX470-4 Size Figure.webp](QIACHIP_RX470-4_Size_Figure.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP RX470-4 Component Description Figure.webp](QIACHIP_RX470-4_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }

<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
  <ul style="flex: 1 1 45%; margin-right: 1%;">
    <li>1: ANT (Antenna Pin)</li>
    <li>2: ANT (Antenna Pin)</li>
    <li>3: VCC (Power Input Pin)</li>
  </ul>
  <ul style="flex: 1 1 45%; margin-left: 1%;">
    <li>4: DOATA (Data Output Pin)</li>
    <li>5: DOATA (Data Output Pin)</li>
...
![QIACHIP RX470-4 Antenna Size Figure 1.webp](QIACHIP_RX470-4_Antenna_Size_Figure_1.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP RX470-4 Antenna Size Figure 2.webp](QIACHIP_RX470-4_Antenna_Size_Figure_2.webp){ width="50%" .center loading="lazy" }
...
| Power Consumption | 3.3mA |
| Receiving Bandwidth | 300 KHz |
