...
# QIACHIP KR2401FB Instruction Manual DC 5V-60V 433MHz RF Remote Control Switch 1-CH Relay Receiver

![QIACHIP KR2401FB Product Diagram.webp](QIACHIP_KR2401FB_Product_Diagram.webp){ width="400" .center loading="lazy" }
...
![QIACHIP KR2401FB Size Figure.webp](QIACHIP_KR2401FB_Size_Figure.webp){ width="400" .center loading="lazy" }

- Receiver Length (L) × Width (W) × Height (H): 38mm × 28mm × 20mm

## Component Description

![QIACHIP KR2401FB Component Description Figure.webp](QIACHIP_KR2401FB_Component_Description_Figure.webp){ width="400" .center loading="lazy" }
...
![QIACHIP KR2401FB Wiring Diagram 1.webp](QIACHIP_KR2401FB_Wiring_Diagram_1.webp){ width="400" .center loading="lazy" }
