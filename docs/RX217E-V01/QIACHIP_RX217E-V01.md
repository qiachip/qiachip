...
# QIACHIP RX217E-V01 Instruction Manual DC 2V-5V 433MHz RF Superheterodyne Wireless Receiver Module

![QIACHIP RX217E-V01 Product Diagram.webp](QIACHIP_RX217E-V01_Product_Diagram.webp){ width="50%" .center loading="lazy" }
...
![QIACHIP RX217E-V01 Size Figure.webp](QIACHIP_RX217E-V01_Size_Figure.webp){ width="68%" .center loading="lazy" }

- Receiver Length (L) x Width (W) x Height (H): 23mm x 9mm x 1mm
- Receiver Pin header pitch: 2.5 mm

## Component Description

![QIACHIP RX217E-V01 Component Description Figure.webp](QIACHIP_RX217E-V01_Component_Description_Figure.webp){ width="50%" .center loading="lazy" }

<div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
  <ul style="flex: 1 1 45%; margin-right: 1%;">
    <li>1: Antenna</li>
    <li>2: VIN+ (Power Input Pin)</li>
    <li>3: DO (Data Output Pin)</li>
  </ul>
  <ul style="flex: 1 1 45%; margin-left: 1%;">
    <li>4: DO (Data Output Pin)</li>
    <li>5: GND- (Power Ground Pin)</li>
  </ul>
</div>
...
![QIACHIP RX217E-V01 Antenna Size Figure 1.webp](QIACHIP_RX217E-V01_Antenna_Size_Figure_1.webp){ width="68%" .center loading="lazy" }
...
![QIACHIP RX217E-V01 Antenna Size Figure 2.webp](QIACHIP_RX217E-V01_Antenna_Size_Figure_2.webp){ width="68%" .center loading="lazy" }
